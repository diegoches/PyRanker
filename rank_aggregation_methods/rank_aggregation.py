...
class RankAggregation(object):
    ...
    def rank(self, *tp_param):
        """
        This function is the one that accomplish the Rank Aggregation
        algorithm. It has to be implemented by all the classes that inherit
        from this class.

        :param tp_param: A tuple of hyper-parameters for the specific
        algorithm. In the case that the algorithm does not have
