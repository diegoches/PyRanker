...
#   The CombSUM algorithm sums for each object its currents similarities in each ranked list, and then it order them in descending order.
#   \cite Fox:1994 .
class RA_CombSUM(RankAggregation):
